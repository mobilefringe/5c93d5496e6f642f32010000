                ...
                this.loadData().then(response => {
                    ...
                    if(temp_repo !== null && temp_repo !== undefined) {
                       ...
                       this.pageBanner = temp_repo[0];
                        ...
                        this.pageBanner = {
                            "image_url": "//codecloud.cdn.speedyrails.net/sites/5d7130df6e6f6418ee010000/image/png/1553624485505/creekside_banner.png"
                        }
                    }
                    ...
                    if (this.currentStore === null || this.currentStore === undefined) {
                        ...
                        _.forEach(this.currentStore.promotions, function(value, key) {
                            ...
                            if (_.includes(current_promo.image_url, 'missing')) {
                                current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5d7130df6e6f6418ee010000/image/png/1553624484143/creekside_placeholder.png";
                            }
                        ...
                        _.forEach(this.currentStore.events, function(value, key) {
                            ...
                            if (_.includes(current_event.image_url, 'missing')) {
                                current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5d7130df6e6f6418ee010000/image/png/1553624484143/creekside_placeholder.png";
                            }
